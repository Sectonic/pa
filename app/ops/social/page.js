    ...
    <div className="main">
      ...
      <div className="section_container">
        ...
        <div className="section extra_margin_section">
          ...
          <div className="section_body less_padding-body">
            <div className="section_text text_aligned-top">
              <div>
                ...
                <h3 className="margin-sm">Di motivated - "I'm coming Up"</h3>
                <p>
            ...
            <div className="section_text text_aligned-top">
              <div>
                ...
                <h3 className="margin-sm">De motivated - "We're all equal"</h3>
                <p>
          ...
          <div className="section_body less_padding-body">
            <div className="section_text text_aligned-top">
              <div>
                ...
                <h3 className="margin-sm">Oe motivated - "Expansive Impact"</h3>
                <p>
            ...
            <div className="section_text text_aligned-top">
              <div>
                ...
                <h3 className="margin-sm">Oi motivated - "Narrowed Focus"</h3>
                <p>
